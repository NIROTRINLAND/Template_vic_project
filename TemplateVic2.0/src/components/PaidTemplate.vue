<template>
  <section class="p-8 lg:p-16 bg-gray-50">
    ...
    <h1 class="text-3xl lg:text-4xl font-extrabold text-indigo-600 mb-6">
      60+ Free HTML Templates
    </h1>

    <!-- Description -->
    <p class="text-gray-700 text-lg max-w-2xl mb-10">
      Tooplate features 
      <span class="font-semibold">60+ free responsive & mobile ready HTML templates</span> 
      ...
      >
        ...
        <div class="p-6">
          ...
          <div class="flex justify-between items-center">
            <span class="text-indigo-600 font-bold text-lg">{{ template.price }}$</span> 
...
<style scoped>
/* Style optionnel : animation légère */
button {
  transform: scale(1);
